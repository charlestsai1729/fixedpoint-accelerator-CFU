...
template <typename tRawType>
FixedPoint<tRawType, 0> one_over_one_plus_x_for_x_in_0_1_cfu(
    FixedPoint<tRawType, 0> a) {

  typedef FixedPoint<tRawType, 0> ResultF;

  ResultF b = ResultF::FromRaw(cfu_op0(13, a.raw(), 0));
  return b;
}
...
//     FixedPoint<tRawType, tIntegerBits> a) {
//   return one_over_one_plus_x_for_x_in_0_1(exp_on_negative_values_for_logistic(-a));
// }
...
FixedPoint<tRawType, 0> logistic_on_positive_values(
  ...
  // u_int32_t tmp = exp_on_negative_values_cfu(a).raw();
  // printf("input: %ld\n", tmp & (((u_int32_t)1 << 31) - 1));
  // u_int32_t out_tmp = one_over_one_plus_x_for_x_in_0_1(exp_on_negative_values_cfu(a)).raw();
  // printf("output: %ld\n", out_tmp & (((u_int32_t)1 << 31) - 1));
  return one_over_one_plus_x_for_x_in_0_1_cfu(exp_on_negative_values_cfu(a));
  // return one_over_one_plus_x_for_x_in_0_1(exp_on_negative_values(-a)); 
  // return one_over_one_plus_x_for_x_in_0_1(exp_on_negative_values_cfu(-a)); 
}
